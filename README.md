...
2. Copy and paste `<script src="https://cdn.jsdelivr.net/gh/pixco12/Console-In-Website-Script@latest/script.js?ts=" + new Date().getTime()"></script>` into the body at the beginning of the body (make sure its before all your scripts). (the Date and getTime is to cache bust and get the latest commit)
