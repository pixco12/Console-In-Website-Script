...
2. Copy and paste `<script src="https://unpkg.com/@pixco12/Console-In-Website-Display-Script@latest/script.js"></script>
` into the body at the beginning of the body (make sure its before all your scripts).
